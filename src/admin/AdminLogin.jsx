...
import { FaLock, FaGraduationCap, FaArrowRight } from 'react-icons/fa';
    ...
    <div className="min-h-screen bg-primary flex items-center justify-center relative overflow-hidden">
      ...
      >
        <div className="p-8 rounded-3xl glass-premium border border-gold/10">
          <button
            onClick={onCancel}
            className="absolute top-4 left-4 p-2 rounded-xl text-textMuted hover:text-gold transition-all duration-300"
          >
            <FaArrowRight />
          </button>
          ...
          <div className="text-center mb-8">
            ...
            <h2 className="text-2xl font-bold gradient-premium calligraphy">لوحة التحكم</h2>
            <p className="text-textSecondary text-sm mt-1">محمد أحمد عرابى - مدرس لغة عربية</p>
          </div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="text-center mt-4">
              <span className="text-xs text-textMuted">كلمة المرور الافتراضية: admin123</span>
            </div>
          </form>
        </div>
      </motion.div>
